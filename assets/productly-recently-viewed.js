        ...
        if($currTarget.classList.contains('open-popup')){
            ...
            if($currTarget.classList.contains('is-open')){
                ...
                if (window.innerWidth < 1025) {
                    ...
                    $('.recently-viewed-popup-mb .productly-recently-viewed').hide();
                    ...
                    if (currPopup == 'productly-recently-viewed-list' && recentlyGrid.hasClass('slick-initialized')) {
                        recentlyGrid.slick('unslick');
                        recentlyGrid.find('.product-info').remove();
                    }
                }else{
                    $('.productly-recently-viewed-popup').append($('.recently-viewed-popup-mb .productly-recently-viewed'));
                    if (currPopup == 'productly-recently-viewed-list' && !recentlyGrid.hasClass('slick-initialized')) {
