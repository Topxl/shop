    ...
    updateAttribute(unavailable = true, disable = true){
        ...
        if(unavailable){
            ...
            if (disable) {
                ...
                if(this.notifyMe){
                    this.notifyMe.querySelector('.productly-notify-product-variant').value = this.currentVariant.title;
...
function showWarning(content, time = null) {
    ...
    const warningPopupContent = document.getElementById('productly-warning-popup').querySelector('[data-productly-warning-content]')
