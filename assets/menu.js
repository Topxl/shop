function menuSidebarMobile() {
    var buttonIconOpen = $('.mobileMenu-toggle'),
        buttonClose = $('.productly-sidebar-close, .background-overlay');
    ...
    $(document).on('click', '.mobileMenu-toggle', function(event) {
        ...
        $('body').addClass('menu_open');
            ...
            // productly.productMenuSlider();
    });

    $(document).on('click', '.productly-sidebar-close, .background-overlay', function() {
    ...
    $(document).on('click', '.productly-sidebar-close', function (e) {
        e.preventDefault();
        e.stopPropagation();
        $('body').removeClass('menu_open');
    });
