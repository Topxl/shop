class CollectionFiltersForm extends HTMLElement {
    ...
    static resizeGridItem(item) {
        grid = document.getElementsByClassName('productly-row--masonry')[0];
    ...
    static renderPage(searchParams, event, updateURLHash = true) {
        ...
        document.body.classList.add('has-productly-loader');
    ...
    static renderProductGrid(html) {
        ...
        document.body.classList.remove('has-productly-loader');

        if (document.querySelector('.collection-masonry')) {
            document.getElementById('CollectionProductGrid').querySelector('.collection .productly-row--masonry').classList.add('is-show');
