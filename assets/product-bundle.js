class ProductBundle extends HTMLElement {
    ...
    onSubmitHandler(event) {
        ...
        const addToCart = () => {
            ...
            this.querySelector('.bundle-product-wrapper').classList.add('has-productly-block-loader');
            ...
            $.post( "/cart", function(data) {
                ...
                try {
                    ...
                    $this.querySelector('.bundle-product-wrapper').classList.remove('has-productly-block-loader');
        ...
        if (!previewCartList) {
            Shopify.getCart((cart) => {
                if(!$.isEmptyObject(cart)){
                    const $cartDropdown = $('#productly-cart-sidebar .productly-sidebar-wrapper .previewCart-wrapper');
