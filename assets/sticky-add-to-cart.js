      ...
      if (this.sticky.classList.contains("style-1")) {
        ...
        const previewBar = document.getElementById("preview-bar-iframe"),
          toolbarMobile = document.querySelector(
            ".productly-sticky-toolbar-mobile"
          );
        ...
        document
          ...
          ?.style.setProperty("bottom", `${height + this.offsetHeight}px`);
  ...
  updateAttribute(disable = true) {
    ...
    if (disable) {
      ...
      if (notifyMe.length > 0) {
        notifyMe
          .find(".productly-notify-product-variant")
        ...
        if (window.subtotal.style == "1") {
          ...
          if (pdView_subTotal != null) {
            if ($("body").hasClass("disable_currencies")) {
              const pdView_subTotal = document.querySelector(
